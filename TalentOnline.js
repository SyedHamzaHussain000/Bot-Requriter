...
const TalentOnline = () => {
  return (
    ...
    <View style={{ height: hp('50%'), alignItems: 'center', justifyContent: 'flex-end' }}>
        <Image source={require('../assets/images/to.png')} style={{ height: 250, width: 250 }} resizeMode={'contain'} />
    </View>

    <View style={{ height: hp('10%'), alignItems: 'center', justifyContent: 'center', width:wp('60%'), alignSelf:'center', marginTop:20 }}>
        <Text style={{ fontSize: 30, fontWeight: 'bold', color: 'brown' }}>LOOK FOR TALENT ONLINE</Text>
    </View>
