  ...
  return (
      <ImageBackground source={require('../assets/images/bg.png')} style={{ width: windowWidth, height: windowHeight }}>
          <View style={{ height: hp('50%'), alignItems: 'center', justifyContent: 'flex-end' }}>
              <Image source={require('../assets/images/fc.png')} style={{ height: 250, width: 250 }} resizeMode={'contain'} />
          </View>

          <View style={{ height: hp('10%'), alignItems: 'center', justifyContent: 'center', width: wp('70%'), alignSelf: 'center', marginTop: 30 }}>
              <Text style={{ fontSize: 30, fontWeight: 'bold', color: 'brown' }}>   BUILD A PEOPLE <Text>FOUCSED CULTURE</Text></Text>
          </View>
          ...
          <View style={{ width: wp('90%'), alignSelf: 'center', height: hp('10%'), flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 20 }}>
              ...
              <View style={{ width: 15, height: 15, backgroundColor: 'brown', borderRadius: 100, alignSelf: 'center', justifyContent: 'center', marginLeft: 20 }} />
