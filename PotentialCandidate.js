...
const PotentialCandidate = () => {
  return (
    ...
    <View style={{ height: hp('50%'), alignItems: 'center', justifyContent: 'flex-end' }}>
        <Image source={require('../assets/images/pc.png')} style={{ height: 250, width: 250 }} resizeMode={'contain'} />
    </View>

    <View style={{ height: hp('10%'), alignItems: 'center', justifyContent: 'center', width: wp('70%'), alignSelf: 'center', marginTop: 30 }}>
        <Text style={{ fontSize: 30, fontWeight: 'bold', color: 'brown' }}>  MEET POTENTIAL <Text>CANDIDATES</Text></Text>
    </View>
