    ...
    return (
        <ImageBackground source={require('../assets/images/bg.png')} style={{ width: windowWidth, height: windowHeight }}>
            <View style={{ height: hp('50%'), alignItems: 'center', justifyContent: 'flex-end' }}>
                <Image source={require('../assets/images/ic.png')} style={{ height: 250, width: 250 }} resizeMode={'contain'} />
            </View>

            <View style={{ height: hp('10%'), alignItems: 'center', justifyContent: 'center', width: wp('80%'), alignSelf: 'center', marginTop: 30 }}>
                <Text style={{ fontSize: 30, fontWeight: 'bold', color: 'brown' }}>INVOLVE EMPLOYEES <Text> IN RECURING</Text></Text>
            </View>
